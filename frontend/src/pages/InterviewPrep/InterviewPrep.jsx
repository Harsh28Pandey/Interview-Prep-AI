...
const InterviewPrep = () => {
    ...
    const uploadMoreQuestions = async () => {
        try {
            ...
            if (response.data) {
                toast.success("Added More Question and Answers")
                fetchSessionDetailsById()
            }
    ...
    return (
        <DashboardLayout>
            ...
            <div className='container mx-auto pt-4 pb-4 px-4 sm:px-6 md:px-10 lg:px-16 shadow-lg'>
                <h2 className='text-lg font-bold color-black'>Interview Q & A</h2>
