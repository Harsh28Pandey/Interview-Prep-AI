...
const AIResponsePreview = ({ content }) => {
    ...
    return (
        <div className='max-w-4xl mx-auto px-2 sm:px-4 lg:px-6 py-4 sm:py-6'>
            <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none break-word overflow-x-auto'>
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        td({ children }) {
                            return <td className='px-3 py-2 break-word text-sm'>{children}</td>
                        },
                        hr() {
