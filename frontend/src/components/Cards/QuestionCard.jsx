            ...
            <div className='bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-lg shadow-gray-400/60 border border-gray-400/60 group'>
                <div className='flex items-start justify-between cursor-pointer'>
                    <div className='flex items-start gap-3.5'>
                        ...
                        <h3 className='text-xs md:text-[14px] font-semibold text-gray-900 mr-0 md:mr-20' onClick={toggleExpand}>
                            {question}
                        </h3>
                    </div>
                    ...
                    <div className='flex items-center justify-end ml-4 relative'>
                        <div className={`flex ${isExpanded ? "md:flex" : "md:hidden group-hover:flex"}`}>
                            <button className='flex items-center gap-2 text-xs text-indigo-900 font-medium bg-indigo-100 px-3 py-1 mr-2 rounded text-nowrap border border-indigo-100 hover:border-indigo-300 cursor-pointer' onClick={onTogglePin}>
                                {isPinned ? (
                            ...
                            <button className='flex items-center gap-2 text-xs text-cyan-900 font-medium bg-cyan-100 px-3 py-1 mr-2 rounded text-nowrap border border-cyan-100 hover:border-cyan-300 cursor-pointer' onClick={() => {
                                setIsExpanded(true)
                                onLearnMore()
                            }}>
                                <LuSparkles />
